...
class ProductFormViewModel {
    ...
    fun calculatePersonalizationPrice() : Double{
        ...
        if(_productState.value.name != "")personalizationPrice += Personalization.PLAYER_NAME_PRICE
        if(_productState.value.number > 0)personalizationPrice += Personalization.PLAYER_NUMBER_PRICE
